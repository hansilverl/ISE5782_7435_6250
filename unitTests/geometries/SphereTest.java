...
class SphereTest {
    ...
    void testFindIntersection() {
        ...
        result=sphere.findIntersection(new Ray(new Point(0.5,0,0),new Vector(3,0,0)));
        assertEquals(List.of(new Point(2,0,0)),result
                ,"Error- Line through the center, ray from inside and cross the sphere");
        assertEquals(1, result.size(), "Wrong number of points");
        ...
        result = sphere.findIntersection(new Ray(new Point(1,0,0),
                new Vector(0,2,0)));
        assertEquals(List.of(new Point(1,1,0)),result,"Error- Line through the center, ray from the center");
        assertEquals(1, result.size(), "Wrong number of points");
