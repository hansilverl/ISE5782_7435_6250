...
class PointTest {
    ...
    @Test
    void testSubtract() {
        //Test that Point - Vector subtraction method works properly
        assertEquals(new Vector(1, 1, 1), p1.subtract(new Vector(0, 1, 2))
                , "ERROR: Point-Vector subtraction does not work correctly");

        //Testing that Point - Point subtraction method works properly
        ...
        assertThrows(IllegalArgumentException.class, () -> p1.subtract(p1), "ERROR: zero point should have thrown an exception");
    }
